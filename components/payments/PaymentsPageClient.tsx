...
export function PaymentsPageClient({
  ...
  initialPayments: PaymentsListResponse;
}) {
  ...
  const {
    ...
    initialData: page === initialPayments.page ? initialPayments : undefined,
    staleTime: 5 * 60_000,
    gcTime: 30 * 60_000,
  });
          ...
          items.map((p) => (
            ...
            >
              ...
              <div className="col-span-2 text-right">
                <Link
                  href={`/payments/${p.id}`}
                  className="inline-flex min-h-[44px] min-w-[44px] items-center justify-end font-medium underline underline-offset-4"
                >
                  →
                </Link>
              </div>
